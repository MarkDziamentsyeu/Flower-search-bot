...
def collect_data_chrysanthemum_1():
    '''parse about bouquets of chrysanthemun from crocus24.by '''
    data = []

    for p in range(1, 4):
        print(p)
        url = f"https://crocus24.by/bukety/bukety-s-hrizantemami/?page={p}"
...
def collect_data_chrysanthemum_2():
    '''parse about bouquets of chrysanthemun from buketti.by '''
    ...
    with open('data/chrysanthemum_buq_2.json', 'w') as file:
...
def collect_data_chrysanthemum_all():
    data = collect_data_chrysanthemum_1()
    datatwo = collect_data_chrysanthemum_2()
...
def main():
    collect_data_chrysanthemum_all()
